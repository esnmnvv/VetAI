...
МалАИ — веб-приложение для фермеров в отдалённых районах Кыргызстана. Пользователь выбирает животное, описывает симптомы или прикрепляет фото, а AI даёт первичную оценку состояния, список срочных действий и признаки, при которых нужно вызывать ветеринара. Интерфейс и AI-ответы доступны на русском и кыргызском языках.
